...
import com.luslusdawmpfe.PFEBackent.entities.Roles;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public String addNewUser(CreateUserDto createUserDto) {
        appUserRepo.findUserByEmail(createUserDto.getEmail())
                .ifPresentOrElse(
                        (appUser)-> new Exception("user already exist!!!"),
                        ()-> {
        ...
        return "User successfully added to system!";
    }
